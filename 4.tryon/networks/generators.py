...
from .normalization import ALIASNorm
from .cnn_networks import FeatureRegression, FeatureCorrelation, FeatureExtraction
...
class SegGenerator(BaseNetwork):
    def __init__(self, opt, input_nc, output_nc=13, norm_layer=nn.InstanceNorm2d):
        ...
        self.isTrain = True if opt['mode'] is 'train' else False  # Train/Test mode
        if self.isTrain:
